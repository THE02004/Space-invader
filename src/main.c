...
// Vector config
 Vector2 victor = {0,0};
 Vector2 Vintro = {0,-500};
 Vector2 Vintro2 = {0,-80};
...
//-----------------------------------------------------------------------------------------
  ...
  // edge 
  int l_pole9 = pole9_x;
  int r_pole9 = pole9_x + pole9_width;
  int u_pole9 = pole9_y;
  int b_pole9 = pole9_y + pole9_height;
  //======================================================================================
  //Deaf
  ...
  bool Mobtrigger = (l_pole9 < r_pole) & (r_pole9 < r_pole) & (u_pole9 < r_pole) & (b_pole9 < r_pole); 
  // Vitess
  int V = 20;
  int VV = 15;
  int frameconter = 0;
 ...
 InitAudioDevice();
  ...
  Texture2D MissPos = LoadTexture("Space-Invaders-Ship.png");
  ...
  Texture2D Overlet = LoadTexture("Overlet2.png");
  Texture2D TMissileExemple = LoadTexture("Space-Invaders-Ship.png");
...
//
    if (IsKeyDown(KEY_SPACE) && PMiss.y > 7000 && waiste == 0 )
    {
      ...
      frameconter2 = 0;
      intframe2 = 0;
      PositionMissExemple.y = PositionMissExemple.y - 40;
      PositionMissExemple.x = PositionMissExemple.x + 50;
    }
    if (IsKeyDown(KEY_SPACE) && PMiss.y > 7000 && f == 0 && PMiss4.y > 1500)
    {
      PositionMissExemple.x = -990;
      PositionMissExemple.y = -2370;
      PlaySound(Shot);
      PMiss.x = realpose.x * -1;
      PMiss.y = realpose.y * -1;
      pole4_x = PMiss.x * -1;
      ...
      frameconter2 = 0;
      intframe2 = 0;
      PositionMissExemple.y = PositionMissExemple.y - 30;
      PositionMissExemple.x = PositionMissExemple.x + 50;
    }
    ...
    { 
      ...
      frameconter2 = 0;
      intframe2 = 0;
      PositionMissExemple.x = PositionMissExemple.x + 270; 
    }
    if (IsKeyDown(KEY_SPACE) && PMiss3.y > 3800 && f == 2 && PMiss2.y > 1500)
    { 
      PositionMissExemple.y = PositionMissExemple.y + 30;
      PositionMissExemple.x = PositionMissExemple.x + 60;
      PlaySound(Shot);
    ...
    DrawTextureRec(playership,Rshep,ShipPose,BLUE);
    DrawTexturePro(Overlet,ExempleMissCadre,ExempleMissCadre,ROverlet,0,WHITE);
    DrawTextureRec(TMissileExemple,DMissExemple,PositionMissExemple,RED);
...
if(collision || !Outofmap || mobhitbox || collision2)
{
  ...
  while (mort< 1)
  {
    ...
    UnloadTexture(img2d);
    UnloadTexture(playership);
    UnloadTexture(TMissileExemple);
    UnloadTexture(Overlet);
...
if (win == 1)
{
  ...
  // win win win win win win win win win win win win win win win win win win win win win win win win
    ...
    //update trigger mob
    l_pole9 = pole9_x;
    r_pole9 = pole9_x + pole9_width;
    u_pole9 = pole9_y;
    b_pole9 = pole9_y + pole9_height;
    // update missile 1
    l_pole4 = pole4_x;
    ...
    Mobtrigger = (l_pole9 < r_pole) && (r_pole9 < l_pole) && (u_pole9 < b_pole) && (b_pole9 < u_pole);  
    Mobtrigger = (l_pole9 < r_pole8) && (r_pole9 < l_pole8) && (u_pole9 < b_pole8) && (b_pole9 < u_pole8);  
    // mob trigger hit box
    //DrawRectangle(pole9_x,pole9_y,pole9_width,pole9_height,BLUE); 
    //sizeofmap  
